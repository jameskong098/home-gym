...
struct Theme {
    ...
    static let sectionTileBackgroundColorLight = UIColor(white: 0.95, alpha: 1.0)
    static let sectionTileBackgroundColorDark = UIColor(red: 50/255, green: 50/255, blue: 50/255, alpha: 0.7)
